...
Vue.component('v-datatable', {
	...
	methods: {
		...
		createPlugin() {
			...
			// definition.language = { url: "/assets/js/plugins/datatables/pl.json",	},		
			

			// definition.dom = '<"datatable-header justify-content-start"f<"ms-sm-auto"l><"ms-sm-3"B>><"datatable-scroll-wrap"t><"datatable-footer"ip>';
